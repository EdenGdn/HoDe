...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function initSectionAnimations() {
    /* Skip sections that start hidden — they are revealed by their own modules */
    var sections = Array.from(document.querySelectorAll('.section')).filter(function(s) {
      return !s.classList.contains('hiring-history--hidden')
          && !s.classList.contains('admin-panel--hidden')
          && !s.classList.contains('dashboard--hidden');
    });
